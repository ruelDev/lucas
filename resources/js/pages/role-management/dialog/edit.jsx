...
export default function EditRole({ role, rolePermissions, permissions, errors: serverErrors = {}, old = {} }) {
    const breadcrumbs = [
        {
            title: 'Roles',
    ...
    const handlRoleSubmit = (e) => {
        ...
        ReactSwal.fire({
            ...
            html: `<p style="font-size: 16px">Saves the changes made to this role. This action will update the user's permission accordingly.</p>`,
            icon: 'question',
            iconColor: '#1B4298',
            ...
            if (result.isConfirmed) {
                ...
                put(route('role-management.update', role.id), {
                    ...
                    onError: (errors) => {
                        ReactSwal.fire({
                            title: 'Error',
                            text: errors.edit_role || 'Failed to edit Role',
                            icon: 'error',
                            confirmButtonText: 'Ok, got it!',
                            confirmButtonColor: '#1B4298',
                        });
