...
export default function DataTable({ data, pagination, filters, columns }) {
    ...
    const handleExport = () => {
        ...
        window.open(`/out-collection-report/lms-posting/newgen-qr-ua/export-newgen-qr-ua?${params.toString()}`, '_blank');
    };
    ...
    const columnLabels = {
        ...
        DEPOSIT_BANK_BRANCH: 'DEPOSIT BANK BRANCH',
        DEPOSIT_BANK_ACCOUNT: 'DEPOSIT BANK ACCOUNT',
        MAKER_REMARKS: 'MAKER REMARKS',
        MIS_NUMBER: 'MIS NUMBER',
