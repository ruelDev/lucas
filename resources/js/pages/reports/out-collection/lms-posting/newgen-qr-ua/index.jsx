...
const breadcrumbs = [
    ...
    {
        title: 'Newgen QR/UA Report',
    },
];

export default function NewgenQrUa({ data, pagination, filters, sort }) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Newgen QR/UA Report" />
            <PageTitle title="Newgen QR/UA Report" description="Manage all newgen qr/ua reports in the system" />
