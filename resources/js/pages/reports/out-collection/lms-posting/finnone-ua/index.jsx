...
const breadcrumbs = [
    ...
    {
        title: 'Finnone UA Report',
    },
];

export default function FinnoneUa({ data, pagination, filters, sort }) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Finnone UA Report" />
            <PageTitle title="Finnone UA Report" description="Manage all finnone ua reports in the system" />
