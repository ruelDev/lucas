...
export const Columns = (sort, handleSort) => [
    {
        ...
        header: () => <DataTableColumnHeader sort={sort} title={'AGREEMENT NO'} handleSort={handleSort} columnName={'AGREEMENTNO'} />,
        cell: ({ row }) => {
            return (
                <div className="pl-4">
    ...
    },
    {
        ...
        header: () => <DataTableColumnHeader sort={sort} title={'RECEIPT NUM'} handleSort={handleSort} columnName={'RECEIPT_NUM'} />,
        cell: ({ row }) => {
            return (
                <div className="pl-4">
    ...
    },
    {
        ...
        cell: ({ row }) => {
            return (
                <div className="pl-4">
                    <TruncatedText text={row.getValue('RECEIPT_CHANNEL')} maxWidth="max-w-[120px]" className="text-sm" />
                </div>
            );
        },
    },
    {
        ...
        cell: ({ row }) => {
            return (
                <div className="pl-4">
                    <TruncatedText text={row.getValue('RECEIPT_AMT')} maxWidth="max-w-[150px]" className="text-sm" />
                </div>
            );
        },
    },
