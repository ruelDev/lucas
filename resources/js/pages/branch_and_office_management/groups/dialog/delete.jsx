...
export default function DeleteGroupDialog({ group, closeDropdown }) {
    ...
    const handleGroupDelete = (e) => {
        ...
        ReactSwal.fire({
            ...
            if (result.isConfirmed) {
                ...
                destroy(route('group-management.destroy', group.id), {
                    preserveState: true,
                    preserveScroll: true,
                    onSuccess: (response) => {
                        ReactSwal.fire({
    ...
    return (
        <>
            {can('group_management.delete') && (
                <button onClick={handleGroupDelete} className="w-full">
