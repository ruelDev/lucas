...
import DeleteGroupDialog from '../dialog/delete';
import EditGroupDialog from '../dialog/edit';
...
const ActionsCell = ({ row }) => {
    ...
    return (
        <DropdownMenu open={dropdownOpen} onOpenChange={setDropdownOpen}>
            {canAny(['group_management.edit', 'group_management.delete'])}
            ...
            <DropdownMenuContent align="end">
                ...
                <div className="flex flex-col space-y-1">
                    ...
                    <DropdownMenuItem asChild>
                        <EditGroupDialog group={row.original} />
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild>
                        <DeleteGroupDialog group={row.original} closeDropdown={() => setDropdownOpen(false)} />
                    </DropdownMenuItem>
                </div>
            </DropdownMenuContent>
        </DropdownMenu>
...
const TableColumns = (sort, handleSort) => [
    {
        accessorKey: 'name',
        header: () => <DataTableColumnHeader sort={sort} title={'Group Name'} handleSort={handleSort} columnName={'name'} />,
