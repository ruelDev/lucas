...
export default function EditDivisionDialog({ division }) {
    ...
    const [cbGroupValue, setCbGroupValue] = React.useState(division.group);
    ...
    const handleDivisionSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(route('division-management.update', division.id), data);
            ReactSwal.fire({
                title: 'Success',
            ...
            setIsOpen(false);
            router.get('/division-management');
        } catch (err) {
            setProcessing(false);
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>Edit a Division.</DialogDescription>
                </DialogHeader>
                <form onSubmit={handleDivisionSubmit} className="space-y-4">
                    <div>
                        <Label html="status" className="mb-2">
                            Division Status <span className="text-red-500">*</span>
                        </Label>
