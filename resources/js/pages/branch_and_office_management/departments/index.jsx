...
export default function Departments({ data, pagination, filters, sort }) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <PageTitle title="Department Management" description="Manage all departments in the system" />
