...
export default function DeleteDepartmentDialog({ department, closeDropdown }) {
    ...
    const handleDepartmentDelete = (e) => {
        ...
        ReactSwal.fire({
            ...
            if (result.isConfirmed) {
                ...
                destroy(route('department-management.destroy', department.id), {
                    preserveState: true,
                    preserveScroll: true,
                    onSuccess: (response) => {
                        ReactSwal.fire({
                    ...
                    onError: (response) => {
                        if (response.delete_department) {
                            ReactSwal.fire({
                                title: 'Error',
                                text: response.delete_department,
                                icon: 'error',
    ...
    return (
        <>
            {can('department_management.delete') && (
                <button onClick={handleDepartmentDelete} className="w-full">
