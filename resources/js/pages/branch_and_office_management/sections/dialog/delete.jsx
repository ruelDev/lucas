...
export default function DeleteSectionDialog({ section, closeDropdown }) {
    ...
    const handleSectionDelete = (e) => {
        ...
        ReactSwal.fire({
            ...
            if (result.isConfirmed) {
                ...
                destroy(route('section-management.destroy', section.id), {
                    preserveState: true,
                    preserveScroll: true,
                    onSuccess: (response) => {
                        ReactSwal.fire({
                    ...
                    onError: (response) => {
                        if (response.delete_section) {
                            ReactSwal.fire({
                                title: 'Error',
                                text: response.delete_section,
                                icon: 'error',
    ...
    return (
        <>
            {can('section_management.delete') && (
                <button onClick={handleSectionDelete} className="w-full">
