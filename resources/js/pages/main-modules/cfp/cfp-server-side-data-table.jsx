...
import column_cfp from '@/pages/main-modules/cfp/column';
import { Loader2 } from 'lucide-react';
import { DataTableControls } from './cfp-data-table-controls';

const ServerSideDataTable = ({ data, pagination, filters, sort, onCreateAction }) => {
    ...
    const columns = useMemo(() => column_cfp(sort, handleSort), [sort, handleSort]);
