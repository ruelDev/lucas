...
export default function Create({ bank }) {
    const breadcrumbs = [
        {
    ...
    const handleSubmit = async (e) => {
        ...
        post(route('bank-management.bank-accounts.store', bank.id), {
            preserveScroll: true,
            preserveState: true,
                ...
                <Card className="p-0">
                    <CardHeader className="flex flex-row items-start gap-3 space-y-0">
                        ...
                        <div>
                            ...
                            <CardDescription>
                                Add an account for <span className="font-semibold text-neutral-700">{bankName}</span>.
                            </CardDescription>
                        </div>
                    </CardHeader>
                    <CardContent>
