...
import column_sample from '@/pages/receipt_posting/columns2';
import { flexRender, getCoreRowModel, useReactTable } from '@tanstack/react-table';
import _ from 'lodash';
import { Loader2 } from 'lucide-react';
import { useCallback, useMemo, useState } from 'react';

const ServerSideDataTable = ({ data, pagination, filters, sort }) => {
    ...
    const columns = useMemo(() => column_sample(sort, handleSort), [sort, handleSort]);
    ...
    return (
        <div className="space-y-4 p-6">
            <Card>
                <CardContent>
                    {/* Controls */}
                    <DataTableControls searchTerm={searchTerm} onSearchChange={handleSearch} onExport={handleExport} />
